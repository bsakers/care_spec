...
RSpec.describe Api::V1::PatientsController, type: :controller do
  let!(:first_patient) { Patient.create(first_name: "Rick", middle_name: "Unknown", last_name: "Riley", age: "52", sex: "Male", race: "Asian", insurance: "Medicare", home_address: "123 Street, Philadelphia, PA") }
  let!(:second_patient) { Patient.create(first_name: "Doode", middle_name: "The", last_name: "Lebowsky", age: "41", sex: "Male", race: "American Indian", insurance: "Aetna", home_address: "456 Street, Philadelphia, PA") }
  ...
  describe "GET#index" do
    ...
    #
    #   expect(returned_json[0][0]["first_name"]).to eq "Rick"
